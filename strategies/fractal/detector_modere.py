"""
Fractal Detector MODÉRÉ: D+KZ+BR
Inside Day + Inside KZ + Breakout+Reversal
Expected: 200-250 signals @ 90-92% WR
"""
import pandas as pd
from datetime import datetime, timedelta

class FractalDetectorModere:
    def __init__(self):
        self.kz_map = {
            'LKZ': (5, 7),      # 5h-7h UTC
    ...
    def detect(self, df_m15, daily):
        """
        Détecte les signaux MODÉRÉ: D+KZ+BR
        """
        signals = []
            ...
            for kz_name, (kz_start, kz_end) in self.kz_map.items():
                ...
                if has_up and has_down:
                    ...
                    signals.append({
                        ...
                        'confidence': 0.91,  # 90-92% WR (midpoint)
                        'levels': {
